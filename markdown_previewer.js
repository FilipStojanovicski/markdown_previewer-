    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(
          'div',
          { className: classes[0] },
          React.createElement(Toolbar, { text: 'Editor', icon: classes[2], onClick: this.handleEditorMaximize }),
          React.createElement(Editor, { markdown: this.state.markdown, onChange: this.handleChange })
        ),
        React.createElement(
          'div',
          { className: classes[1] },
          React.createElement(Toolbar, { text: 'Previewer', icon: classes[2], onClick: this.handlePreviewMaximize }),
...
var Editor = function Editor(props) {
  return React.createElement('textarea', { id: 'editor', type: 'text', onChange: props.onChange, value: props.markdown });
};

var Preview = function Preview(props) {
  var preview = props.markdown;
  var markdown = marked.parse(preview);
  return React.createElement('div', { dangerouslySetInnerHTML: { __html: markdown }, id: 'preview' });
};
...
var Toolbar = function Toolbar(props) {
  return React.createElement(
    'div',
    { className: 'toolbar' },
    React.createElement('i', { className: 'fa fa-brands fa-github-alt', title: 'no-stack-dub-sack' }),
    props.text,
